        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img src="src/assets/biblio.jpeg" alt="Bibliothèque ATNV" className="rounded-lg shadow-xl w-full" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <img src="src/assets/toumai.jpeg" alt="Projet web toumai" className="w-full h-48 object-cover" />
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <img src="src/assets/formation.jpeg" alt="Formation de femme leaders" className="w-full h-48 object-cover" />
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <img src="src/assets/femme.jpeg" alt="Formation de femme informaticienne" className="w-full h-48 object-cover" />
            </div>
          </div>
        </div>
      </section>
...
<section className="py-20 bg-white">
  <div className="max-w-7xl mx-auto px-7 sm:px-9 lg:px-10"> 
    ...
    <h2 className="text-lg text-gray-900 leading-relaxed text-center"> {/* Centré pour la cohérence avec le titre h1 */}
